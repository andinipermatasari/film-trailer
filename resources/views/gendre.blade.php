            ...
            <div class="ml-28 mt-6 flex flex-row items-center">
                ...
                <div class="relative ml-4">
                    ...
                    onchange="changeSort(this)">
                        <option value="origin_country">Action</option>
                        <option value="origin_country">Roman</option>
                        <option value="origin_country">Fantasi</option>
                        <option value="origin_country">Fiksi</option>
                    </select>
                </div>
            </div>
